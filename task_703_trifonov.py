...
class Cell:
    ...
    def __add__(self, other):
        return f'Объединение двух клеток. Размер новой клетки равен: {self.quantity + other.quantity}'

    def __sub__(self, other):
        sub = self.quantity - other.quantity
        return f'Вычитание клеток. Новый размер: {sub} ' if sub > 0 else 'Разность должна быть больше нуля'
